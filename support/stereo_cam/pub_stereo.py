...
import cv2
import numpy as np
#import rospy old ros import replaced with rclpy MSK
import rclpy 
...
if __name__ == '__main__':
    ...
    """ros1 node intiialization, ROS2 node after MSK 
    rospy.init_node('stereo_cam')
    """
    rclpy.init(args=None)
    stereo_cam = rclpy.create_node('stereo_cam')
    ...
    try:
        ...
        while not rclpy.is_shutdown(): #updated rospy to rclpy
            ...
            stamp = rclpy.Time.from_sec(time.time()) #updated library from rospy to rclpy MSK
    ...
    except rclpy.exceptions.ROSInterruptException: #updated library from rospy to rclpy MSK
        pass